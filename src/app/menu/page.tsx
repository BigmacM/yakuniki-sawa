        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="sticky top-20 z-30 bg-ink/95 backdrop-blur-sm -mx-4 px-4 py-3 mb-10 border-b border-ember/20">
            <div className="flex overflow-x-auto gap-2 pb-1 scrollbar-thin">
              {[
                { id: 'premium-wagyu', icon: '🥩', label: 'Premium WAGYU' },
                { id: 'standard-beef', icon: '🔥', label: 'Standard Beef' },
                { id: 'pork-chicken', icon: '🍗', label: 'Pork & Chicken' },
                { id: 'seafood', icon: '🦐', label: 'Seafood' },
                { id: 'sashimi-salads', icon: '🥗', label: 'Sashimi & Salads' },
                { id: 'rice-soups', icon: '🍜', label: 'Rice & Soups' },
